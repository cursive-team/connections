...
PrismaPostgresClient.prototype.CreateAuthTokenForUser = async function (userId: string): Promise<AuthToken> {
...
PrismaPostgresClient.prototype.CreateAuthToken = async function (createAuthToken: AuthTokenCreateRequest): Promise<AuthToken> {
