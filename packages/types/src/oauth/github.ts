import {z} from "zod";
import {AccessToken, StravaActivityRunStatsSchema} from "./index";
...
export function MapGithubCommitContributionsToLeaderboardEntry(username: string, chipIssuer: ChipIssuer, resp: any): LeaderboardEntry {
